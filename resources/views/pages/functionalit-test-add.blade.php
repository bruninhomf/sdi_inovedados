    ...
    <div class="card">
      <div class="card-content">
        ...
        <div class="col s12" id="account">
          ...
          <form action="/testes-funcionais" method="POST">
            @csrf
            <div class="row">
              ...
              <div class='element' id='module-1'>
                ...
                <div id='flush-collapse1' class='accordion-collapse collapse show' aria-labelledby='flush-heading1'> 
                  <div class='accordion-body' id='teste1'>
                    <div class='col s12 input-field'>
                      <input name='modulos[1][description]' type='text' class='validate' required> 
                    ...
                    <div class='test-body'>
                      <div class='input-field col s12'>
                        ...
                        <textarea name='modulos[1][test]' class='pt-2 materialize-textarea col s12'></textarea>  
                      </div>

                      <div class='input-field col s12'>
                        <label for='result'>Resultado à apresentar</label>
                        <textarea name='modulos[1][result]' class='pt-2 materialize-textarea col s12'></textarea>  
                      </div>

                      <div class="col s12 input-field">
                        <label  for="status">Situação</label>
                        <select class="mt-4 browser-default" name="modulos[1][status]">
