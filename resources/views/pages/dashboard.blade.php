      ...
      <div class="ct-chart card z-depth-2 border-radius-6">
        <div class="card-content">
          <div class="row">
            ...
            <div class="col s6 right-align">
              <p class="mt-4 green-text"><i class="material-icons dp48 vertical-align-bottom">arrow_upward</i>
                1896</p>
            </div>
            <div class="col s12 display-flex">
               <div class="sample-chart-wrapper"><canvas id="polar-ii" height="200"></canvas></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="ct-chart card z-depth-2 border-radius-6">
        <div class="card-content">
          <div class="row">
            ...
            <div class="col s6 right-align">
              <p class="mt-4 pink-text"><i class="material-icons dp48 vertical-align-bottom">arrow_upward</i>
                1896</p>
            </div>
            <div class="col s12 display-flex">
               <div class="sample-chart-wrapper"><canvas id="polar-iii" height="200"></canvas></div>
            </div>
          </div>
        </div>
      </div>
