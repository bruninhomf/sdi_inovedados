  ...
  <div class="users-list-table">
    <div class="card">
      <div class="card-content">
        ...
        <div class="col s12">
            <h4 h4 class="card-title indigo-text pb-5"><strong>Teste de Cruds</strong></h4>
        </div>
              ...
              <div class='element' id='module-1'>
                ...
                <div id='flush-collapse1' class='accordion-collapse collapse' aria-labelledby='flush-heading1'> 
                  <div class='accordion-body' id='teste1'>
                    <div class='col s12 input-field'>
                      <input name='modulos[1][name]' type='text' class='validate' required> 
                    ...
                    <div class='description-body'>
                      <div class='input-field col s12'>
                        ...
                        <textarea name='modulos[1][description]' class='pt-2 materialize-textarea col s12'></textarea>  
                      </div>

                      <div class='col s6 input-field'>
                        <label  for='register'>Cadastrar</label>
                        <select class='mt-5 browser-default' name='modulos[1][register]'>
                      ...
                      <div class='col s6 input-field'>
                        ...
                        <select class='mt-5 browser-default' name='modulos[1][view]'>
                          <option value='' disabled='' selected=''></option>
                          <option value='Funcionando'>Funcionando</option>
                          <option value='Não funciona'>Não funciona</option>
                          <option value='Em correção'>Em correção</option>
                      ...
                      <div class='col s6 input-field'>
                        ...
                        <select class='mt-5 browser-default' name='modulos[1][edit]'>
                          <option value='' disabled='' selected=''></option>
                          <option value='Funcionando'>Funcionando</option>
                          <option value='Não funciona'>Não funciona</option>
                          <option value='Em correção'>Em correção</option>
                      ...
                      <div class='col s6 input-field'>
                        ...
                        <select class='mt-5 browser-default' name='modulos[1][delete]'>
                          <option value='' disabled='' selected=''></option>
                          <option value='Funcionando'>Funcionando</option>
                          <option value='Não funciona'>Não funciona</option>
                          <option value='Em correção'>Em correção</option>
                      ...
                      <div class='pb-4 col s12 right-align'>
                        <span id='remove_' class='mt-4 red btn btn-floating btn-reset remove' style='border-radius: 5px; width:50px;'>
                          <i class='material-icons'>clear</i>
                        </span>
                      </div>
                    </div> 
