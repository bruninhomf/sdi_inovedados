<html>
<head>
<title>Servidor de hospedagem</title>
</head>
<body>
<div>
  <div>
    <div>
      <div>
        <div style="height: 50px; padding-top: 160px; padding-bottom: 171px; text-align: center">
          ...
          <table cellspacing="0" style="width: 100%; color: #595959; text-align: justify; line-height: 25px; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
            <tbody>
              <tr style="background-color: #f6f6f6;">
                ...
                <td style="padding-left: 200px;">{{ $hostingproposal->diskspace }}</td>
              </tr>
              <tr style="background-color: #dbdcdd">
                <td style="padding-left: 10px;">Trafego</td>
                <td style="padding-left: 200px;">{{ $hostingproposal->traffic }}</td>
              </tr>
              <tr style="background-color: #f6f6f6">
                <td style="padding-left: 10px;">Dominios</td>
                <td style="padding-left: 200px;">{{ $hostingproposal->domanins }}</td>
              </tr>
              <tr style="background-color: #dbdcdd">
                <td style="padding-left: 10px;">Subdominios</td>
                <td style="padding-left: 200px;">{{ $hostingproposal->subdomains }}</td>
              </tr>
              <tr style="background-color: #f6f6f6">
                <td style="padding-left: 10px;">Caixa de e-mail</td>
                <td style="padding-left: 200px;">{{ $hostingproposal->mailboxes }}</td>
              </tr>
              <tr style="background-color: #dbdcdd">
                <td style="padding-left: 10px;">Contas FTP</td>
                <td style="padding-left: 200px;">{{ $hostingproposal->ftp_accounts }}</td>
              </tr>
              <tr style="background-color: #f6f6f6">
                <td style="padding-left: 10px;">Banco de dados</td>
                <td style="padding-left: 200px;">{{ $hostingproposal->database }}</td>
              </tr>
              <tr style="background-color: #dbdcdd">
                <td style="padding-left: 10px;">Processos PHP</td>
                <td style="padding-left: 200px;">{{ $hostingproposal->php_processes }}</td>
              </tr>
            </tbody>
          </table>
        </div>

        <div style="padding: 10px 75px 0px 75px; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
          <p>Localização: Data Center Park Falkenstein, Alemanha.</p>
          <div >
            <h6>
              Valor: R$ {{ $hostingproposal->value }} mensais
              <br>
          ...
          <table style="padding: 326px 0px 0px 0px; color: #7f7f7f; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
            <tr>
