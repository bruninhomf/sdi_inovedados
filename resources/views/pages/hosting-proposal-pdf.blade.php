    ...
    <div>
      <div>
              ...
              <table>
                <tr>
                  <td style="padding: 25px 0px 25px 0px;">
                    <h2 style="color: white">Servidor de <br>hospedagem</h2>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style="color: white; padding-left: 60px; padding-top: 70px; text-align: right; white-space: nowrap;">
                    ...
                    <div style="border: 1px solid #891629"><h4>Rua dos Guajajaras, 910, Sala 1619 </h4> <img src="images/icon/address_white.png" style="margin-left: 5px"></div>
        ...
        <div style="padding: 25px">
          ...
          <table style="padding: 290px 0px 0px 0px">
            <tr>
