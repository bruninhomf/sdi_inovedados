...
{{-- page title --}}
@section('title','Edit testes de Caso de Uso')
  ...
  <div class="users-list-table">
    <div class="card">
      <div class="card-content">
        ...
        <div class="col s12">
          <h4 h4 class="card-title indigo-text pb-5"><strong>Edit testes de Caso de Uso</strong></h4>
        </div>
          ...
          <form action="/teste-caso-de-uso" method="POST">
            ...
            <div class="row">
              <div class="col s12 input-field">
                <input id="project_name" name="project_name" type="text" class="validate" value="{{ $usecasetestsystems->project_name }}" required>
            ...
            <div class='accordion accordion-flush' id='accordionElement'>
              <div class='element' id='module-1'>
                ...
                @foreach($usecasetestsystems->modules as $key => $module)
                ...
                <div id='flush-collapse1' class='accordion-collapse collapse show' aria-labelledby='flush-heading1'> 
                  <div class='accordion-body' id='teste1'>
                    <div class='col s12 input-field'>
                      <input id='name' name='modulos[1][name]' type='text' class='validate' value="{{ $module->description }}" required> 
                    ...
                    <div class='test-body'>
                      <div class='input-field col s12'>
                        ...
                        <textarea id='test' name='modulos[1][test]' class='pt-2 materialize-textarea col s12'>{{ $requirements->test }}</textarea>  
                      </div>

                      <div class='input-field col s12'>
                        <label for='result'>Resultado à apresentar</label>
                        <textarea id='result' name='modulos[1][result]' class='pt-2 materialize-textarea col s12'>{{ $requirements->result }}</textarea>  
                      </div>
