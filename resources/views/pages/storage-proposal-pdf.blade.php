<html>
<head>
<title>Servidor de armazernamento</title>
</head>
<body>
<div>
  <div>
    <div>
      <div>
          ...
          <table cellspacing="0" style="width: 100%; color: #595959; text-align: justify; line-height: 25px; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
            <tbody>
              <tr style="background-color: #f6f6f6;">
                ...
                <td style="padding-left: 200px;">{{ $storageproposal->diskspace }}</td>
              </tr>
              <tr style="background-color: #dbdcdd">
                <td style="padding-left: 10px;">Memoria</td>
                <td style="padding-left: 200px;">{{ $storageproposal->traffic }}</td>
              </tr>
              <tr style="background-color: #f6f6f6">
                <td style="padding-left: 10px;">Rede</td>
                <td style="padding-left: 200px;">{{ $storageproposal->connections }}</td>
              </tr>
              <tr style="background-color: #dbdcdd">
                <td style="padding-left: 10px;">Sistema operacional</td>
                <td style="padding-left: 200px;">{{ $storageproposal->accounts }}</td>
              </tr>
            </tbody>
          </table>
        </div>

        <div style="padding: 20px 75px 0px 75px; line-height: 1.8; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
          <ul>
            <li>
              FTP
            </li>
        ...
        <div style="padding: 10px 75px 0px 75px; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
          ...
          <div >
            <h6>
              Valor: R$ {{ $storageproposal->value }} mensais
              <br>
          ...
          <table style="padding: 128px 0px 0px 0px; color: #7f7f7f; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
            <tr>
