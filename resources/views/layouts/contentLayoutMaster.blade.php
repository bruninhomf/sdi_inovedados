...
<head>
  ...
  <title>@yield('title') | INOVE DADOS </title>
  <link rel="apple-touch-icon" href="{{asset('images/favicon/favicon-inovedados.png')}}">
  <link rel="shortcut icon" type="image/x-icon" href="{{asset('images/favicon/favicon-inovedados.png')}}">
